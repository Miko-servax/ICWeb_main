        ...
        series : [
            {
                ...
                center: ['50%', '40%'],
                data: [
                    {value: 1079.90, name: '林业用地面积'},
                    {value: 368.70, name: '人工林面积'}
                ],
                label: {
                    normal: {
                        show: false,
        ...
        series: [
            {
                name:'碳排放总量',
                type:'bar',
                data:[1.57,1.67,1.75,1.82,1.81,2.02,2.10,2.11,2.29],
                boundaryGap: '45%',
                barWidth:'40%',
...

            {
                ...
                data:[3.5,3.71,3.86,4,4.1,4.39,4.52,4.54,4.91]
            }
        ]
    };
        ...
        series: [
            {
                ...
                data: [411,451,469,432,508,520,472,555,725,699,768,787]
            },
            {
                name: '煤炭消费量/千万吨',
                type: 'bar',
                ...
                data: [526,535,624,698,680,725,747,769,761,776,787,799]
            }
        ]
    };
