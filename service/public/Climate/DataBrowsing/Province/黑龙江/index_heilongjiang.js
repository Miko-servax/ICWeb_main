        ...
        series : [
            {
                ...
                center: ['50%', '40%'],
                data: [
                    {value: 2453.77, name: '林业用地面积'},
                    {value: 243.26, name: '人工林面积'}
                ],
                label: {
                    normal: {
                        show: false,
        ...
        series: [
            {
                name:'碳排放总量',
                type:'bar',
                data:[2.77,2.65,2.81,2.86,2.98,2.96,2.67,2.88,2.57],
                boundaryGap: '45%',
                barWidth:'40%',
...

            {
                ...
                data:[7.23,6.92,7.35,7.51,7.84,7.84,7.1,7.7,6.86]
            }
        ]
    };
        ...
        series: [
            {
                ...
                data: [1735,2065,2106,2200,2166,2127,2141,2123,2210,1905,1552,1534]
            },
            {
                name: '煤炭消费量/十万吨',
                type: 'bar',
                ...
                data: [1120,1105,1221,1320,1396,1326,1359,1343,1403,1446,1337,1414]
            }
        ]
    };
