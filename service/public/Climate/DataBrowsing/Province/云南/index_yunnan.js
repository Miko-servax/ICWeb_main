        ...
        series : [
            {
                ...
                center: ['50%', '40%'],
                data: [
                    {value: 2599.44, name: '林业用地面积'},
                    {value: 507.68, name: '人工林面积'}
                ],
                label: {
                    normal: {
                        show: false,
        ...
        series: [
            {
                name:'碳排放总量',
                type:'bar',
                data:[1.92, 1.83, 1.71, 1.47, 1.51, 1.68, 1.74, 1.8, 1.46],
                boundaryGap: '45%',
                barWidth:'40%',
...

            {
                ...
                data:[4.12, 3.92, 3.63, 3.10, 3.18, 3.51, 3.61, 3.71, 3.01]
            }
        ]
    };
        ...
        series: [
            {
                ...
                data: [0.7, 0.6, 0.2, 0.2, 0.3, 0.3, 1.2, 2.7 ,4.1, 10.1, 10.8,11]
            },
            {
                name: '煤炭消费量/百万吨',
                type: 'bar',
                ...
                data: [88, 93, 96, 98, 97, 86, 77, 74, 72, 74, 75,79]
            }
        ]
    };
