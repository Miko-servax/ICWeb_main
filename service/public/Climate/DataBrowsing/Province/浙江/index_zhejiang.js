        ...
        series : [
            {
                ...
                center: ['50%', '40%'],
                data: [
                    {value: 659.77, name: '林业用地面积'},
                    {value: 244.65, name: '人工林面积'}
                ],
                label: {
                    normal: {
                        show: false,
        ...
        series: [
            {
                name:'碳排放总量',
                type:'bar',
                data:[3.98,4.08,4.05,4.05,4.11,4.32,4.4,4.23,4.69],
                boundaryGap: '45%',
                barWidth:'40%',
...

            {
                ...
                data:[7.28,7.43,7.35,7.31,7.37,7.64,7.68,7.23,8.02]
            }
        ]
    };
        ...
        series: [
            {
                ...
                data: [2287,2505,2835,2939,2732,2853,2731,2846,2667,3038,2769,3472]
            },
            {
                name: '煤炭消费量/十万吨',
                type: 'bar',
                ...
                data: [1304,1327,1394,1477,1437,1416,1382,1382,1394,1426,1418,1367]
            }
        ]
    };
