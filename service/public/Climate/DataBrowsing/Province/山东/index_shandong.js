        ...
        series : [
            {
                ...
                center: ['50%', '40%'],
                data: [
                    {value: 349.34, name: '林业用地面积'},
                    {value: 256.11, name: '人工林面积'}
                ],
                label: {
                    normal: {
                        show: false,
        ...
        series: [
            {
                name:'碳排放总量',
                type:'bar',
                data:[95.1,81.4,85.0,88,87,86,94.4,100.9,90.8],
                boundaryGap: '45%',
                barWidth:'40%',
...

            {
                ...
                data:[9.82,8.42,8.69,8.94,8.75,8.6,9.4,10.02,9.03]
            }
        ]
    };
        ...
        series: [
            {
                ...
                data: [5142,5593,5826,6271,6766,7815,8607,10203,11487,13035,13632,14987]
            },
            {
                name: '煤炭消费量/万吨',
                type: 'bar',
                ...
                data: [34795,37327,38921,40233,37683,39561,40926,40939,38164,42319,32132,33154]
            }
        ]
    };
