    ...
    option = {
        ...
        series : [
            ...
            },
            {
                ...
                smooth:true,
                symbol:'roundRect',
                data:[10,10,8.5,8.3,8,8.1,7.8,6]
            }
        ]
    };
        ...
        series : [
            {
                ...
                center: ['50%', '40%'],
                data: [
                    {value: 1629.5, name: '林业用地面积'},
                    {value: 733.53, name: '人工林面积'}
                ],
                label: {
                    normal: {
                        show: false,
        ...
        series: [
            {
                name:'碳排放总量',
                type:'bar',
                data:[1.79,1.77,1.73,1.61,1.72,1.80,1.88,1.98,1.84],
                boundaryGap: '45%',
                barWidth:'40%',
...

            {
                ...
                data:[3.83,3.77,3.65,3.36,3.58,3.69,3.82,4.01,3.72]
            }
        ]
    };
        ...
        series: [
            {
                ...
                data: [133,163,396,1064,1473,1296,1390,1428,1340,1563,1599,1637]
            },
            {
                name: '煤炭消费量/万吨',
                type: 'bar',
                ...
                data: [4676,5199,6206,7033,7264,7344,6796,6046,6517,6613,7339,8021]
            }
        ]
    };
