        ...
        series : [
            {
                ...
                center: ['50%', '40%'],
                data: [
                    {value: 787.25, name: '林业用地面积'},
                    {value: 167.63, name: '人工林面积'}
                ],
                label: {
                    normal: {
                        show: false,
        ...
        series: [
            {
                name:'碳排放总量',
                type:'bar',
                data:[4.69,4.76,4.64,4.37,4.49,4.73,4.92,5.06,5.16],
                boundaryGap: '45%',
                barWidth:'40%',
...

            {
                ...
                data:[13,13.12,12.72,11.93,12.21,12.80,13.23,13.58,13.86]
            }
        ]
    };
        ...
        series: [
            {
                ...
                data: [6328.5, 7167.3, 7933.2, 7323.4, 7493.2, 8191.3, 8318.6, 8027.6, 7936.2, 7726.4, 6481.3, 6742.5]
            },
            {
                name: '煤炭消费量/万吨',
                type: 'bar',
                ...
                data: [28372,27761,29865,33479,34551,36636,37587,37115,36621,42942,48940,51331]
            }
        ]
    };
