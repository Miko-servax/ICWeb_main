        ...
        series : [
            {
                ...
                center: ['50%', '40%'],
                data: [
                    {value: 1080.29, name: '林业用地面积'},
                    {value: 615.51, name: '人工林面积'}
                ],
                label: {
                    normal: {
                        show: false,
        ...
        series: [
            {
                name:'碳排放总量',
                type:'bar',
                data:[5.51,5.39,5.57,5.66,5.39,5.91,6.13,5.76,6.93],
                boundaryGap: '45%',
                barWidth:'40%',
...

            {
                ...
                data:[5.21,5.07,5.20,5.22,4.91,5.29,5.41,5.01,6.02]
            }
        ]
    };
        ...
        series: [
            {
                ...
                data: [3046,3709,4455,4403,4511,4929,4765,4899,5044,5209,5920,5632]
            },
            {
                name: '煤炭消费量/万吨',
                type: 'bar',
                ...
                data: [13298,13647,15983,18439,17634,17106,17013,16587,16135,17172,17067,16833]
            }
        ]
    };
