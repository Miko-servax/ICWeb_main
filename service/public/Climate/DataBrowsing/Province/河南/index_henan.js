    ...
    option = {
        ...
        series : [
            ...
            },
            {
                ...
                smooth:true,
                symbol:'roundRect',
                data:[10,9.5,9.5,9.3,9.2,9,8.9,6]
            }
        ]
    };
        ...
        series : [
            {
                ...
                center: ['50%', '40%'],
                data: [
                    {value: 520.74, name: '林业用地面积'},
                    {value: 245.78, name: '人工林面积'}
                ],
                label: {
                    normal: {
                        show: false,
        ...
        series: [
            {
                name:'碳排放总量',
                type:'bar',
                data:[5.26,5.16,5.20,5.07,5.10,4.94,4.72,4.53,4.64],
                boundaryGap: '45%',
                barWidth:'40%',
...

            {
                ...
                data:[5.6,5.49,5.51,5.35,5.36,5.17,4.92,4.71,4.82]
            }
        ]
    };
        ...
        series: [
            {
                ...
                data: [704,785,835,874,1010,963,845,847,707,658,828,799]
            },
            {
                name: '煤炭消费量/十万吨',
                type: 'bar',
                ...
                data: [2386,2444,2605,2837,2524,2505,2424,2371,2322,2266,2233,2004]
            }
        ]
    };
