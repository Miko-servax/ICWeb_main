    ...
    option = {
        ...
        series : [
            ...
            },
            {
                ...
                smooth:true,
                symbol:'roundRect',
                data:[11,10,9.8,9,8.5,8.6,8.5,8.4]
            }
        ]
    };
        ...
        series : [
            {
                ...
                center: ['50%', '40%'],
                data: [
                    {value: 1257.59, name: '林业用地面积'},
                    {value: 501.51, name: '人工林面积'}
                ],
                label: {
                    normal: {
                        show: false,
        ...
        series: [
            {
                name:'碳排放总量',
                type:'bar',
                data:[2.94,2.76,2.75,2.90,3.06,3.11,3.04,2.99,2.36],
                boundaryGap: '45%',
                barWidth:'40%',
...

            {
                ...
                data:[4.43,4.13,4.09,4.28,4.49,4.54,4.41,4.33,3.42]
            }
        ]
    };
        ...
        series: [
            {
                ...
                data: [614,565,587,766,926,946,801,878,841,770,949,935]
            },
            {
                name: '煤炭消费量/十万吨',
                type: 'bar',
                ...
                data: [1016,1075,1132,1300,1208,1122,1089,1114,1144,1240,1092,1066]
            }
        ]
    };
