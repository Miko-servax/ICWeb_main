        ...
        series : [
            {
                ...
                center: ['50%', '40%'],
                data: [
                    {value: 924.40, name: '林业用地面积'},
                    {value: 385.59, name: '人工林面积'}
                ],
                label: {
                    normal: {
                        show: false,
        ...
        series: [
            {
                name:'碳排放总量',
                type:'bar',
                data:[2.24,2.21,2.35,2.32,2.12,2.32,2.51,2.60,2.45],
                boundaryGap: '45%',
                barWidth:'40%',
...

            {
                ...
                data:[6,5.86,6.2,6.05,5.49,5.96,6.38,6.56,6.18]
            }
        ]
    };
        ...
        series: [
            {
                ...
                data: [706,1141,963,1104,1007,2044,2164,2089,2083,2144,2559,2550]
            },
            {
                name: '煤炭消费量/万吨',
                type: 'bar',
                ...
                data: [6595,7109,7026,8714,8485,8078,8198,7659,6826,7442,8558,8718]
            }
        ]
    };
