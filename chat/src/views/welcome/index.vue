...
function toHome() {
  router.push('/Welcome/Welcome.html')
}
</script>
        ...
        <svg id="store" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="130 0 1230 930">
          ...
          <defs>
            ...
            <g id="plane">
              ...
              <text transform="matrix(1.0027 0 0 1 44.8218 224.8768)" font-family="Fredoka One" font-size="34" fill="#0170BB"> 欢迎来访、祝你玩的开心...... </text>
          ...
          <circle class="cat-shadow" fill="#0170BB" cx="1160" cy="620" r="23" />
...
/* 对于宽度小于或等于 768 像素的设备，将 .store-container 宽度设置为 100% */
@media only screen and (max-width: 768px) {
  .store-container {
    width: 100%;
  }
}
/* 对于宽度大于 768 像素且小于或等于 1200 像素的设备，将 .store-container 宽度设置为 80% */
@media only screen and (min-width: 769px) and (max-width: 1200px) {
  .store-container {
    width: 80%;
  }
}
/* 对于宽度大于 1200 像素的设备，将 .store-container 宽度设置为 50% */
