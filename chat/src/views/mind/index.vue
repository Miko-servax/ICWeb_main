  ...
  <div class="flex grow flex-col sm:flex-row h-full">
    ...
    >
      <div class="flex-1 px-4 pb-2">
        ...
        <header class="flex items-center py-3" v-if="isMobile">
    ...
    <div
      class="h-full flex-1 overflow-y-auto overflow-hidden min-h-[80vh] flex flex-col"
    >
      <header class="flex items-center p-5" v-if="!isMobile">
        <h2 class="font-bold text-2xl">思维导图</h2>
      </header>
